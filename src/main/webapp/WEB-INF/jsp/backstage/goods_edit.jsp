...
<script type="text/javascript">
	...
	<body>
		<div class="container">
			<fieldset>
				<legend align="center">修改商品</legend>

				<form action="admin/goods_edit" method="post" class="student-form" enctype="multipart/form-data">
				
					<div>
						<label for="stuId">商品ID：</label> <input type="text" name="id" id="id" readonly="readonly"
							value="${goods.id }">
					</div>
					<div>
