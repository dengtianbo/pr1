...
<script src="js/goods_list.js" type="text/javascript"></script>
...
<body>
	<div class=" page-content clearfix">
		...
		<!-- 分页和条件查询 -->
		<form action="admin/goods_list" method="post" class="search_goods_form">
		
		<div class="search_style">
					
				<ul class="search_content clearfix">
					<li><label class="l_f">商品ID</label><input name="id" type="text"
						class="text_add" placeholder="输入商品id" style="width: 100px" /></li>
					<li><label class="l_f">商品名称</label><input name="name" type="text"
						class="text_add" placeholder="输入商品名称" style="width: 100px" /></li>
					<li><label class="l_f">商品价格</label><input name="price" type="text"
						class="text_add" placeholder="输入商品价格" style="width: 100px" /></li>
					<li><label class="l_f">商品热度</label><input name="heat" type="text"
						class="text_add" placeholder="输入商品名称" style="width: 100px" /></li>
			...
			<div class="border clearfix">
				<span class="l_f"> <a href="admin/goods_add" title="添加商品"
				...
				</span> <span class="r_f">共：<b>${count }</b>件商品
				</span>
			</div>
			<!--产品列表展示-->
					...
					<table class="table table-striped table-bordered table-hover"
						...
						<thead>
							<tr>
								...
								<th width="100px">主图片</th>
								<th width="50px">价格</th>
								<th width="50px">商品详情ID</th>
								<th width="50px">种类ID</th>
								<th width="50px">热度</th>
						...
						<tbody>
							...
							<c:forEach items="${list }" var="goods">
								<tr>
									...
									<td width="50px" class="idd">${goods.id }</td>
									<td width="100px">${goods.name }</td>
								
									<td width="100px">
									<img src="${goods.picture }" class="picture-pic"  data-portrait="${goods.picture }" style="width: 50px ;height: 50px " >
									</td>
									
									
									<td width="50px">${goods.price }</td>
									<td width="50px">${goods.pdid }</td>
									<td width="50px">${goods.classid }</td>
									<td width="50px">${goods.heat }</td>
									<td width="180px">${goods.ms }</td>
