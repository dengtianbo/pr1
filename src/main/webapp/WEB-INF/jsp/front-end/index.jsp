    	...
    	<div class="nav">
            ...
            <div class="leftNav">
                <ul>  
                 ...
                 <c:forEach items= "${list1 }"  var="goodsClass1" >
                	<li>
                    	<div class="fj">
                        	<span class="n_img"><span></span><img src="images/nav1.png" /></span>
                            <span class="fl">${goodsClass1.name}</span>
                        </div>
                        <div class="zj"  style="top: 0px;">
                            <div class="zj_l">
                            
                           
                            <c:forEach items= "${list2}"  var="goodsClass2"  >
		                           <c:choose>
			                            <c:when test="${goodsClass2.pid == goodsClass1.id }">
			                            	<div class="zj_l_c">
			                                   <h2>${goodsClass2.name}</h2>
			                                   <c:forEach items= "${list3 }"  var="goodsClass3">
			                                   <c:choose>
				                                   	<c:when test="${goodsClass2.id == goodsClass3.pid }">
					                                   <a href="client/goods?id=1">${goodsClass3.name}</a>|
					                                  </c:when>
			                                   </c:choose>
                            ...
                            <c:forEach items="${goodslist }" var="goods">
	                            <li class="featureBox">
	                                    <div class="box">
	                                        ...
	                                        <div class="imgbg">
	                                        	<a href="client/goods?id=${goods.id }"><img src="${goods.picture }" width="160" height="136" /></a>
	                                        </div>                                        
	                                        <div class="name">
	                                        	<a href="client/goods?id=${goods.id }">
	                                            <h2>${goods.name }</h2>
	                                            ${goods.ms }
	                                            </a>
	                                        </div>
	                                        <div class="price">
	                                            <font>￥<span>${goods.price }</span></font>
	                                        </div>
	                                    </div>
	                              </li>
