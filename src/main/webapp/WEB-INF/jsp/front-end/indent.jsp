			...
			<div class="content mar_20">
				<div class="two_bg">
					...
					<table border="0" class="car_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
						<tr>
							<td class="car_th" width="80">商品id</td>
						...
						<tr>
							<td class="idd">${goods.id }</td>
							<td>
								<div class="c_s_img"><img src="${goods.picture }" width="73" height="73" /></div>
								<b style="font-size: 20px ; text-align: center;"> ${goods.name }</b>
							</td>
							<td align="center">${goods.ms }</td>
								<c:forEach items="${buy }" var="b">
									<c:choose>
										<c:when test="${goods.id == b.goods_id }">
										<td align="center">${b.number }</td>
										</c:when>
									</c:choose>
								</c:forEach>
							<td align="center" style="color:#ff4e00;">￥ <b >${goods.price }</b></td>
						</tr>
						...
						<tr height="70">
							<td align="right">
								<b style="font-size:14px;">应付款金额：<span
										style="font-size:22px; color:#ff4e00;">￥<b>${price }</b></span></b>
							</td>
						</tr>
						<tr height="70">
							<td align="right"><a id="sub_btn"><img src="images/btn_sure.gif" /></a></td>
						</tr>
					</table>
