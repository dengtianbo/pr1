...
<div class="soubg">
	<div class="sou">
        <span class="fr">
        	<span class="fl">你好，请<a href="user/login">登录</a>&nbsp; <a href="user/regist" style="color:#ff4e00;">免费注册</a>&nbsp; </span>
            ...
            <table border="0"  style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
              <tr height="50" valign="top">
                ...
                <td>
                    ...
                    <span class="fr">已有商城账号，<a href="user/login" style="color:#ff4e00;">我要登录</a></span>
                </td>
              </tr>
              <tr height="50">
              ...
              <tr height="50">
                ...
                <td><input type="password" value="" class="l_pwd" name="password2" /></td>
              </tr>
              <tr height="50">
              ...
              <tr height="50">
                ...
                <td><input type="text" value="" class="l_tel" name="nickname" /></td>
              </tr>
